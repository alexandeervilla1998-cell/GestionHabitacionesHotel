    ...
    <div class="flex min-h-screen">
        <aside class="hidden w-2/5 border-r-2 border-hotel-mid bg-hotel-dark lg:flex lg:flex-col lg:justify-between">
            <div class="p-10 animate-hotel-fade">
                <div class="mb-8 flex h-14 w-14 items-center justify-center rounded-xl border-2 border-hotel-light bg-white transition-transform duration-200 overflow-hidden hotel-glow">
                    <img src="{{ asset('uploads/habitaciones/loscracks.png') }}" alt="Logo" class="h-full w-full object-cover">
                </div>
                <h2 class="text-3xl font-bold leading-tight hotel-brand-mark">Hotel Los Cracks</h2>
